...
class DocumentService:
    ...
    def list_documents(self, notebook_id: str) -> List[str]:
        ...
        """
        return self.doc_repository.list_documents(notebook_id)
    ...
    def upload_document(
        ...
        storage_path = f"{user_id}/{notebook_id}/{safe_pdf_storage_path(document_name)}"
        ...
        self.doc_repository.delete_by_name(document_name, notebook_id)
    ...
    def upload_from_bytes(
        ...
        try:
            ...
            result = self.upload_document(notebook_id, user_id, tmp_path, document_name)
            return result
        finally:
    ...
    def delete_document(self, notebook_id: str, user_id: str, document_name: str) -> bool:
        """
        ...
        documents = self.doc_repository.list_documents(notebook_id)
        if document_name not in documents:
            raise ValueError(f"Document '{document_name}' not found")

        # Delete from database
        success = self.doc_repository.delete_by_name(document_name, notebook_id)
